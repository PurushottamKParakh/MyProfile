      ...
      <main className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            {courses.map((course, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-blue-600 font-medium">{course.status}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {talks.map((talk, index) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-2">{talk.date}</p>
              </a>
            ))}
          </div>
        </Section>
        ...
        <Section title="Collaborate" icon={<MessageSquare />}>
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className="text-gray-700 mb-4">{collaboration.availability}</p>
            <a 
